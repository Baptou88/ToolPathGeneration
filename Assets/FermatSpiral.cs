...
// // void calculate_break(path, start, radius)
...
// // void outer_spiral(path, distance)
...
// // void inner_spiral(outer_pieces, distance, center, path) {   
// //     spiral = []
// //     if not outer_pieces{
// //         pass
// //     else{
...
// // void convert_fermat(path,distance, debug=False)
...
// // void combine_paths(root, branches, dis){
...
// // //
// // void generate_total_path(isocontours, distance)
// //     {
// //     total_path = []
// //     contour_family = []
...
// // //
// // void generate_total_path_connected(isocontours, distance)
// //     {
// //     branches = []
...
// List<Geometry> execute(List<List<Vector2>> polygons, float distance, bool connected=false, int boundaries=0)
//    { 
//     //assert not boundaries < 0


//     List<Geometry> total_path = new();
